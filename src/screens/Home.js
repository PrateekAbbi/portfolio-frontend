...
const HomeScreen = () => {
  ...
  useEffect(() => {
    axios({
      method: "get",
      url: "https://portfolio-backend-3hylr1ewv-prateekabbi-ufledu.vercel.app/aboutApi/aboutDetails",
    }).then((data) => {
    ...
    // axios
    //   .get("http://localhost:5000/aboutApi/aboutDetails")
    //   .then((data) => {
    //     console.log(data)
    //     setName(data.data.name);
    //     setEmail(data.data.email);
    ...
    axios
      .get(
        "https://portfolio-backend-3hylr1ewv-prateekabbi-ufledu.vercel.app/resumeApi/resumeDetails"
      )
      .then((data) => {
    ...
    axios
      .get(
        "https://portfolio-backend-3hylr1ewv-prateekabbi-ufledu.vercel.app/portfolioApi/getProjects"
      )
      .then((data) => {
    ...
    axios
      .get(
        "https://portfolio-backend-3hylr1ewv-prateekabbi-ufledu.vercel.app/socialMediaApi/socialMediaLinksDetails"
      )
      .then((data) => {
        ...
        <div className="container-fluid">
          <div className="row">
            ...
            <div className="col-lg-8 no-padding">
              ...
              />
              <Portfolio portfolio={portfolio} projects={projects} />
              <Contact
                contact={contact}
                email={email}
                number={number}
