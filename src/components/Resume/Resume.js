...
const Resume = () => {
  ...
  useEffect(() => {
    axios
      .get(
        "https://portfolio-backend-7oyj6co60-prateekabbi-ufledu.vercel.app/resumeApi/resumeDetails"
      )
      .then((data) => {
  ...
  const updateResume = () => {
    axios
      .put(
        "https://portfolio-backend-7oyj6co60-prateekabbi-ufledu.vercel.app/resumeApi/resume",
        {
          year,
          title,
          organization,
