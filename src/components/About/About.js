...
const About = () => {
  ...
  useEffect(() => {
    axios
      .get(
        "https://portfolio-backend-7oyj6co60-prateekabbi-ufledu.vercel.app/aboutApi/aboutDetails"
      )
      .then((data) => {
  ...
  const handleSave = () => {
    ...
    axios
      .put(
        "https://portfolio-backend-7oyj6co60-prateekabbi-ufledu.vercel.app/aboutApi/about",
        {
          email,
          name,
          number,
  ...
  const handleDelete = (id) => {
    axios.put(
      "https://portfolio-backend-7oyj6co60-prateekabbi-ufledu.vercel.app/aboutApi/deleteSkill",
      { id }
    );
  };
